...
-Displays the top results and opens the links in the default web browser.
...
A valid YouTube Data API Key. You can obtain it from the Google Developer Console.
